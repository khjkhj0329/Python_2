...
class Bubbletea(Drink):
    ...
    def set_pearl(self):
        ...
        if pearl == '0':
            self.set_pearl()
            return
        self.pearl = 2 if pearl == '' else int(pearl) - 1   #self.pearl에 넣자
    def __str__(self):
